    ...
    <div class="container">
        ...
        <form class="form">
            <div class="form__row align-centered">
                ...
                <label for="indistrict" class="form__radio-button switcher">Проживаю в округе</label>
                <input id="outdistrict" name="district" value="out" class="form__input--hidden" type="radio">
                <label for="outdistrict" class="form__radio-button switcher">За пределами округа</label>
            </div>
            ...
            <div class="form__block form__block-outdistrict form__block--hidden">
                ...
                <div class="form__row">
                    <label for="surname" class="form__label">фамилия</label>
                    <input id="surname" name="surname" class="form__input form__input--botom" type="text" pattern="[a-zA-Z,а-яА-Я]+" required>
                </div>
                <div class="form__row">
                    <label for="phone" class="form__label">Телефон</label>
                    <input id="phone" name="phone" class="form__input" type="tel" pattern="^((8|\+7)[\- ]?)?(\(?\d{3}\)?[\- ]?)?[\d\- ]{7,10}$" required>
