            ...
            <form>
                <div class="">
					...
					<span class="passwordChangeContainer">
                        ...
                        <div class="form__row form__row--lined">
                            <div class="form__title text-big">Привязка соцсетей</div>
                        </div>
                        <div class="form__row form__row--social_login">
                            <div>
                                <label for="" class="form__label">ВКонтакте</label><br/>
                                <div class="text-link text-small">Привязать</div>
                                <div class="text-link text-link--active text-link--hidden text-small">Отвязать</div>
                            </div>
                            <div>
                                <label for="" class="form__label">Одноклассники</label><br/>
                                <div class="text-link text-small">Привязать</div>
                                <div class="text-link text-link--active text-link--hidden text-small">Отвязать</div>
                            </div>
                            <div>
                                <label for="" class="form__label">Фейсбук</label><br/>
                                <div class="text-link text-small">Привязать</div>
                                <div class="text-link text-link--active text-link--hidden text-small">Отвязать</div>
                            </div>
                            <div>
                                <label for="" class="form__label">Твиттер</label><br/>
                                <div class="text-link text-link--hidden text-small">Привязать</div>
                                <div class="text-link text-link--active text-small">Отвязать</div>
                            </div>
                        </div>
