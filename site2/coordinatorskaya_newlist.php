<div class="content coordinatorskaya coordinatorskaya_new">
    <div class="dashboard">
        <div class="container flexbox">
            ...
            <div class="flexbox__item">
                <div class="flexbox__container">
                    <a href="" class="button button--blue" type="button">Заявка в шефы</a>
                    <a href="" class="button button--blue">Добавить шефа</a>
                    <a href="" class="button button--gray button--small">Добавить голосующего</a>
                </div>
            </div>
        </div>
    </div>
    <div class="coord chief">
        <div class="table_nav">
            <div class="container">
                <div class="table_nav__item table_nav__item--active" data-table="table--application">
                    <span>Список заявок в шефы</span>
                </div>
                <div class="table_nav__item" data-table="table--allpersons">
                    <span>Все шефы</span>
                </div>
                <div class="table_nav__item" data-table="table--alltasks">
        ...
        <div class="container">
                ...
                <div class="table__row table__body">
                    ...
                    <div class="table__cell">
                        <div class="table__remove">
                            <img src="static/images/icon-remove.png">
                        </div>
                    </div>
                </div>
            ...
            <div class="table table_main table--alltasks">
                <div class="table__row table__header">
                    <div class="table__cell"><span>Cортировать <span class="table__cell--blue">по количеству выполненных</span></span></div>
                    <div class="table__cell"></div>
                    <div class="table__cell">
                        <div class="slider_header">
                            <div class="slider_header__title">Дела</div>
                            <div class="slider_header__content flexbox">
                                <div class="flexbox__item">
                                    <div class="slider_header__num text-small">№1</div>
                                    <div class="slider_header__popup">Знакомство с сайтом</div>
                                </div>
                                <div class="flexbox__item">
                                    <div class="slider_header__num text-small">№2</div>
                                    <div class="slider_header__popup">Знакомство с сайтом</div>
                                </div>
                                <div class="flexbox__item">
                                    <div class="slider_header__num text-small">№3</div>
                                    <div class="slider_header__popup">Знакомство с сайтом</div>
                                </div>
                                <div class="flexbox__item">
                                    <div class="slider_header__num text-small">№4</div>
                                    <div class="slider_header__popup">Знакомство с сайтом</div>
                                </div>
                                <div class="flexbox__item">
                                    <div class="slider_header__num text-small">№5</div>
                                    <div class="slider_header__popup">Знакомство с сайтом</div>
                                </div>
                            </div>
                            <div class="slider_header__controls slider_header__controls--left"></div>
                            <div class="slider_header__controls slider_header__controls--right"></div>
                        </div>
                    </div>
                </div>
                <div class="table_wrap">
                    <div class="table__row table__body" id="first_row">
                        <div class="table__cell">
                            <div class="person-block flexbox">
                                <div>
                                    <div class="person-block__img person-block__img--small">
                                    ...
                                    <div class="flexbox">
                                        <div class="flexbox__item">
                                            <div class="statuses__item">
                                                <div class="icon_status icon_status--undefined"></div>
                                            </div>
                                        </div>
                                        <div class="flexbox__item">
                                            <div class="statuses__item">
                                                <div class="icon_status icon_status--check"></div>
                                            </div>
                                        </div>
                                        <div class="flexbox__item">
                                            <div class="statuses__item">
                                                <div class="icon_status icon_status--alert"></div>
                                            </div>
                                        </div>
                                        <div class="flexbox__item">
                                            <div class="statuses__item">
                ...
                <div class="table_wrap">
                    ...
                    <div class="table__cell">
                        <div class="status_board">
                            <div class="flexbox">
                                <div class="flexbox__item">
                                    <div class="status_board__item">
                                        <div class="icon_status icon_status--check"></div>
                                        <span class="text-small">Выполнил</span>
                                    </div>
                                    <div class="status_board__item">
                                        <div class="icon_status icon_status--undefined"></div>
                                        <span class="text-small">Не начал</span>
                                    </div>
                                </div>
                                <div class="flexbox__item">
                                    <div class="status_board__item">
                                        <div class="icon_status icon_status--alert"></div>
                                        <span class="text-small">Ожидает проверки</span>
                                    </div>
                                </div>
                            </div>
                        </div>
