<div class="content pomoshnik">
    ...
    <div class="container">
        <div class="flexbox your__info">
            <div class="flexbox__item form">
                <div class="form__row">
                    <div class="text-small text-small--light">Твой координатор</div>
                    <div class="text-big">Виктория Черняховская</div>
            ...
            <div class="flexbox__item progressboard">
                ...
                <div class="campaignprogress">
                    ...
                    <div class="counter">
                        <div class="counter__plusone bounceInRight">+13</div>
