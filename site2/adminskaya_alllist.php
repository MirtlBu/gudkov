    ...
    <div class="container">
        <div class="admin reqlist">
            ...
            <div class="alllist-filter">
                ...
                <label for="coords-filter" class="form__checkbox">
                    <span>Координаторы</span>
                </label>
                <input id="helpers-filter" name="helpers-filter" value="helpers-filter" class="form__input form__input--hidden" type="checkbox" onChange="$();">
                <label for="helpers-filter" class="form__checkbox">
                    <span>Помощники</span>
                </label>
            </div>
            <div class="table">
                <div class="table__header flexbox">
                    ...
                    <div class="text-small flexbox__item">По координатору</div>
                ...
                <div class="table__row flexbox listitem">
                    ...
                    <div class="flexbox__item">
                        ...
                        <div class="reqlist__person">
                            ...
                            <div class="reqlist__coord text-small">
                                <span class="text-small text-light">Координатор:</span>
                                <span class="text-small">Вероника Медведева</span>
                            </div>
                        </div>
                    </div>
                    <div class="flexbox__item">
