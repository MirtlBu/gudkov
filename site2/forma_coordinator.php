<div class="content">
    ...
    <div class="container">
        <div class="forma_coordinator">
            <div class="text-bigger main-title">Добавить координатора</div>
            <form class="form">
                <div class="form__row">
                    <label for="uik" class="form__label">УИК</label>
                    <input id="uik" name="uik" class="form__input" type="text" required>
                </div>
